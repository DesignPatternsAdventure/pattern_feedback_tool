...
Copied from: https://github.com/pythonarcade/community-rpg/blob/e71ba00a24a40de8a0bde37748b9c221d397aac6/rpg/views/game_view.py

used under the MIT license for testing of the feedback tool.
...
class GameView(arcade.View):
    ...
    def load_hotbar_sprites(self):
        ...
        Loads the controls sprite tileset and selects only the number pad button sprites. These will be visual
        representations of number keypads (1️⃣, 2️⃣, 3️⃣, ..., 0️⃣) to clarify that the hotkey bar can be accessed
        through these keypresses.
    ...
    def on_resize(self, width, height):
        """Resize window Handle the user grabbing the edge and resizing the window."""
